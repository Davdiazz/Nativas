...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstaceState) {
        ...
        // Variabless
        imageViewBack = findViewById(R.id.ivBackIcon_Register);
        editTextName = findViewById(R.id.etnombre_Register);
        editTextLastname = findViewById(R.id.etapellido_Register);
        editTextEmail = findViewById(R.id.etemail_Register);
        editTextPhone = findViewById(R.id.etcelular_Register);
        editTextPassword = findViewById(R.id.etpassword_Register);
        editTextRepeatPassword = findViewById(R.id.etRepeatPassword_Register);
        checkBoxConditions = findViewById(R.id.cbConditions_Register);
        buttonLogin = findViewById(R.id.tvLogin_Register);
